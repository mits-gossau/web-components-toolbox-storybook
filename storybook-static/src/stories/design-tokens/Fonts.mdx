...
<h1 className="helvetica-now-text-bold">Headline HelveticaNowTextBold</h1>

<p className="helvetica-now-text-bold">Lorem Ipsum dolor HelveticaNowTextBold ...</p>
...
<h1 className="avenir-35-light">Headline Avenir35Light</h1>

<p className="avenir-35-light">Lorem Ipsum dolor Avenir35Light ...</p>
